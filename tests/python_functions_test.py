...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
    volume_of_cube = calculate_volume_of_cube( 5 )
    self.assertEqual(125, volume_of_cube)

  #Given a String, return the String reversed
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    reversed_string=reverse_a_string("Why you spying on my code?")
    self.assertEqual("?edoc ym no gniyps uoy yhW",reversed_string)

  #Given a value in farenheit, convert this into celsius.
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    converted_temp=farenheit_to_celsius(176)
    self.assertEqual(80,converted_temp)
